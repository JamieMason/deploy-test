...
pub struct Instance {
  ...
  /// The version specifier which deploy-test has determined this instance should
...
impl Instance {
  ...
  /// Record what deploy-test has determined the state of this instance is and what
